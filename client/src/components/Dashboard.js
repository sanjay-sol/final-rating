  ...
  return (
    <>
      <nav className="  container mx-auto flex flex-wrap items-center justify-between  ">
        ...
        <ul className="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-2 md:text-sm md:font-medium ">
      ...
      <div className="bg-red-500 hover:bg-red-600  items-center m-5 p-6 py-4 leading-none rounded text-lg  uppercase text-white font-bold inline-block">
        <span>
          {" "}
          ✓ Total Users :{" "}
          <span className="text-xl text-neutral-900"> {totalusers}</span>{" "}
        </span>
      </div>
          ...
          {data.length >= 1 ? (
            data
              ...
              .map((profile, index) => (
                <div
                  key={index}
                  className="w-full border mt-5 border-gray-600 rounded-lg shadow-black shadow-lg hover:shadow-violet-600 hover:shadow-2xl"
                >
                  <div className="flex flex-col items-center justify-center p-10">
                    <a
                      href={`https://res.cloudinary.com/dgo3xjjvb/image/upload/v${profile.versionid}/${profile.publicid}.${profile.format}`}
                      target="_blank"
                      rel="noreferrer"
                      className="block"
                    >
          ...
          <div class="w-96 border border-gray-600 rounded-lg shadow-2xl ">
            <div class="flex flex-col mb-3 items-center justify-center p-10">
              <Link to="/viewprofile">
                <img
                  class="w-32 h-32 mb-6 rounded-full"
                  src="https://i.pinimg.com/originals/5d/67/66/5d67663f8a4637838965b25bb4b5ba17.jpg"
                  alt="Profile"
                />
              </Link>
